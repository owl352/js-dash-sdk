...
var systemIds_4 = require("@dashevo/withdrawals-contract/lib/systemIds");
...
var Client = /** @class */ (function (_super) {
    ...
    function Client(options) {
        ...
        _this.network = _this.options.network ? _this.options.network.toString() : 'mainnet';
    ...
    Client.prototype.getWalletAccount = function (options) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                ...
                options = __assign({ index: this.defaultAccountIndex, synchronize: true }, options);
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        _a.label = 2;
                    case 2: return [4 /*yield*/, this.dapiClient.disconnect()];
                    case 3:
                        _a.sent();
                        return [2 /*return*/];
                }
